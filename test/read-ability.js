...
var readability = {
    ...
    prepDocument: function () {
        ...
        //判断frames，最适合的frames的大小应该最大（宽度加高度）
    ...
    **/
    grabArticle: function () {
        ...
        **/
        ...
        {
            //通过类名或id来判断不太可能的节点，剔除掉：combx|comment|disqus|foot|header|menu|rss|shoutbox|sidebar|sponsor/i,
            //保留body
            //如果类名或id有可能是得节点，保留：/and|article|body|column|main/i,
            ...
            //div如果子元素没有块级，转p，块级：/<(a|blockquote|dl|div|img|ol|p|pre|table|ul)/i,
            //否则，通过提取其中的text_node并且拼接
            if (node.tagName === "DIV") {
        ...
        **/
        //找到最佳候选后，要看它的兄弟节点，评分以最佳候选的分数*0.2为基准，最小为10
        ...
        for(var s=0, sl=siblingNodes.length; s < sl; s++)
        {
            ...
            if(siblingNode.nodeName == "P") {
                ...
                //长度大于80，链接密度小于2.5，为正文
                if(nodeLength > 80 && linkDensity < 0.25)
                {
                    append = true;
                }
                //长度小于80，链接密度为0，且能找到". 或.$"的，为正文
